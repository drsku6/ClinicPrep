...
export default function SignInPage() {
  ...
  const handleEmailAuth = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // The AuthProvider will detect the state change and redirect automatically.
      router.push('/prepare');
    } catch (err) {
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      // signInWithRedirect will navigate away, and the AuthProvider will catch the result.
      ...
      setLoading(false); // Only reached if signInWithRedirect itself throws an error immediately
    }
  };
